            ...
            filteredTasks.map(task => (
              ...
              >
                {editingTask === task._id ? (
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-start">
                      <h3 className={`text-base sm:text-lg font-semibold text-gray-900 ${task.status === 'Done' ? 'line-through text-gray-500' : ''} pr-2`}>
                        {task.title}
                      </h3>
                      <div className="flex gap-1">
                        <button
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="truncate text-indigo-600 font-medium">{task.assignedTo || 'Unassigned'}</span>
                      </div>
                      
                      <div className="flex items-center gap-2 text-sm">
                        <Calendar size={12} className="text-emerald-500" />
                        <span className="text-emerald-600 font-medium">{task.dueDate ? new Date(task.dueDate).toLocaleDateString() : 'No date'}</span>
                      </div>
                    </div>
