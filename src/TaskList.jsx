...
//     } else if (diffDays <= 2) {
//       return { status: 'urgent', daysLeft: diffDays };
//     } else if (diffDays <= 7) {
...
//               <div
//                 key={task._id}
//                 className={`${getCardStyling(task)} rounded-xl p-4 sm:p-5 shadow-sm hover:shadow-md transition-all duration-200 ${
//                   task.isPinned ? 'ring-2 ring-blue-300' : ''
//                 }`}
//               >
//                 {editingTask === task._id ? (
//                   // Edit Mode
...
const TaskList = ({ refresh, searchText }) => {
  ...
  const InfoTooltip = ({ taskId }) => {
    return (
      <div className="relative">
        <button
          onClick={() => setShowTooltip(showTooltip === taskId ? null : taskId)}
        ...
        {showTooltip === taskId && (
          <div className="absolute bottom-full right-0 mb-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg p-3 z-10">
            <div className="text-xs font-semibold text-gray-700 mb-2">Card Color Legend:</div>
            <div className="space-y-1.5">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-gradient-to-r from-red-50 to-red-100 border-l-2 border-red-500 rounded-sm"></div>
                <span className="text-xs text-gray-600">Red - Overdue tasks</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-gradient-to-r from-orange-50 to-orange-100 border-l-2 border-orange-500 rounded-sm"></div>
                <span className="text-xs text-gray-600">Orange - Due today</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-gradient-to-r from-yellow-50 to-yellow-100 border-l-2 border-yellow-500 rounded-sm"></div>
                <span className="text-xs text-gray-600">Yellow - Due in 1-2 days</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-gradient-to-r from-blue-50 to-blue-100 border-l-2 border-blue-500 rounded-sm"></div>
                <span className="text-xs text-gray-600">Blue - Due in 3-7 days</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-white border border-gray-200 rounded-sm"></div>
                <span className="text-xs text-gray-600">White - No due date / 7+ days</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-white opacity-60 border border-gray-200 rounded-sm"></div>
                <span className="text-xs text-gray-600">Faded - Completed tasks</span>
              </div>
            </div>
          </div>
        )}
